...
const options_entry emu_options::s_option_entries[] =
{
	...
	{ OPTION_THROTTLE_THRESHOLD ";tt",                   "3.0",       OPTION_FLOAT,      "percentage of error allowed between game speed and display refresh rate to achieve smooth scrolling" },
	...
	{ OPTION_SKIP_GAMEINFO ";si",                        "0",         OPTION_BOOLEAN,    "skip displaying the information screen at startup" },
